  ...
  return (
    <div>
      ...
      {policyToCompare.length > 0 ? (
            ...
            <div key={policy.policy_id} className="col-md-6">
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  <p><strong>Claim Type:</strong> {policy.claim_type}</p>
                  <p><strong>Coverage Amount:</strong> Rs.{policy.coverage_amount}</p>
                  <p><strong>Premium:</strong> Rs.{policy.details.premium}</p>
                  <p><strong>Deductible:</strong> Rs.{policy.details.deductible}</p>
                  <p><strong>Duration:</strong> {policy.mount}</p>
        ...
        <div className="text-center">No policies selected for comparison.</div>
      )}
    </div>
    </div>
  )
