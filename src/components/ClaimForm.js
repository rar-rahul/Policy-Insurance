        ...
        <form onSubmit={handleSubmit(handleClaimSubmit)}>
          ...
          <div className="mb-3">
            ...
            <textarea
              ...
              id="claimDescription"
              {...register('claimDescription', { required: "Claim description is required" })}
              placeholder="Describe the incident or reason for the claim"
            />
            {errors.claimDescription && <p className="text-danger">{errors.claimDescription.message}</p>}
          </div>
          ...
          <div className="mb-3">
            ...
            />
            {errors.claimAmount && <p className="text-danger">{errors.claimAmount.message}</p>}
          </div>
          ...
          <div className="mb-3">
            ...
            />
            {errors.incidentDate && <p className="text-danger">{errors.incidentDate.message}</p>}
          </div>
